 ...
 * {@link AccFragment.OnFragmentInteractionListener} interface
...
public class AccFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button signoutButton = (Button) view.findViewById(R.id.signoutBth);
        TextView accTextView = (TextView) view.findViewById(R.id.AccTextView);
        try {
            accTextView.setText(user.getDisplayName());
        }catch (Exception e){
            accTextView.setText(user.getEmail());
        }
